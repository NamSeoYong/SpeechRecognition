...
def training_pipeline(config):
    ...
    test_acc, test_loss, roc_auc = evaluate(model, criterion, valloader, config["hparams"]["device"])  # 검증 데이터셋 사용
    log_dict = {
    ...
    test_acc, test_loss, roc_auc = evaluate(model, criterion, testloader, config["hparams"]["device"])
    log_dict = {
        "test_loss_best": test_loss,
        "test_acc_best": test_acc,
        "roc_auc": roc_auc
